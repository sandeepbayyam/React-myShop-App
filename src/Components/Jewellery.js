...
import {getJewelery} from '../store/actions/jewelleryActions'
...
const Jewellery = (props) => {
  ...
  useEffect(()=>{
    props.dispatch(getJewelery());
  },[]);
  
  useEffect(()=>{
    setProducts(...props.jewellery.jewellery)
  },[props.jewellery])
  ...
  return (
    <div>
      <Nav/>
      <h1 className='text-center'>Jewellery's</h1>
...
export default connect(store=>store) (Jewellery);
